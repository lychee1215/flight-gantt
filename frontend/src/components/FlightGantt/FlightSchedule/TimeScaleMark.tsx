...
export const TimeScaleMark: React.FC<TimeScaleMarkProps> = ({ startTime, endTime, unitHours, leftPadding, oneHourWidth, flightNumber }) => {
    
    const times: Date[] = [];
    let time: number = getLastHourTime(startTime.getTime());
    let lastOneMarkTime: number = getLastHourTime(endTime.getTime()) + 1000 * 60 * 60;
